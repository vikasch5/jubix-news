                                    ...
                                    <div class="swiper"
                                        ...
                                        <div class="swiper-wrapper">
                                            @foreach ($allbreakingNews as $breakingNews)
                                                @php
                                                    $bnewsImages = json_decode($breakingNews->images, true); // field name may be different
                                            ...
                                            <div class="block-content">
                                                <div class="row child-cols-12 g-2 lg:g-4 sep-x">
                                                    @foreach ($alllatestNews as $latestNews)
                                                        @php
                                                            $latestimages = json_decode($latestNews->images, true); // field name may be different
                                                                    ...
                                                                    <div>
                                                                        <div class="post-header panel vstack justify-between gap-1">
                                                                            <h3 class="post-title h5 lg:h4 m-0 text-truncate-2">
                                                                                <a class="text-none hover:text-primary duration-150"
                                                                                    href="{{ route('news.detail', $latestNews->slug) }}">{{ $latestNews->title }}</a>
                                                                            </h3>
                                                                        </div>
                                                                        <p
                                                                            class="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">
                                                                            {{ \Illuminate\Support\Str::words(strip_tags($latestNews->description), 50, '...') }}
