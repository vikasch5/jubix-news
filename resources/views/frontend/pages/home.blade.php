                                            ...
                                            <div class="widget-content">
                                                ...
                                                <a class="cstack max-w-300px mx-auto text-none"
                                                    ...
                                                    <img class="d-none sm:d-block"
                                                        src="{{ asset(firstImage($ad->images)) }}" alt="{{ $ad->title ?? 'Advertisement' }}">
                                ...
                                <div class="widget ad-widget vstack gap-2 text-center p-2 border">
                                    <div class="widgt-content">
                                        ...
                                        <a class="cstack max-w-300px mx-auto text-none" href="{{ $ad->link ?? '#' }}"
                                            ...
                                            <!-- Desktop / Light Mode -->
                                            <img class="d-block dark:d-none" src="{{ asset($image) }}" alt="{{ $ad->title ?? 'Advertisement' }}">

                                            <!-- Desktop / Dark Mode -->
                                            <img class="d-none dark:d-block" src="{{ asset($image) }}" alt="{{ $ad->title ?? 'Advertisement' }}">
